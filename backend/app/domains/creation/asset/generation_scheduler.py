...
from app.domains.creation.asset.prompt_fusion import PromptFusion
from app.utils.gen_helpers import import_cycle_detector, import_topo_sort
...
class GenerationScheduler:
    ...
    async def run_generation(self, graph: KnowledgeGraph) -> dict:
        ...
        topo_sort_mod = import_topo_sort()
        try:
